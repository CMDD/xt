...
<body style="background:#F7F7F7; width: 90%; margin-top: 20%;margin: auto;">
                 ...
                 <div class="">
                       ...
                       <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                         <a href="ixtus">
                           <div class="tile-stats">
                               ...
                               <h3>Plataforma general</h3>
                               <p>Herramienta de gestion.</p>
                           </div>
                           </a>
                       </div>
                         <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
                     ...
                     <div class="row">
                         <div class="col-md-12">
                             <div class="x_panel">
                                 <div class="x_title">
                                     <h2>Resumen general <small>ixtus 2.0</small></h2>
                                     <div class="filter">
                                         <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                                             <i class="glyphicon glyphicon-calendar fa fa-calendar"></i>
                                             <span>Fecha actual</span> <b class="caret"></b>
                                         </div>
                                     </div>
