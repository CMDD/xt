                        ...
                        <td  align='center' width='530'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class="contentEditable" style='font-size:32px;color:#555555;font-weight:normal;'>
                              <img src="{{asset('/mails/logo.png')}}" alt='' data-default="placeholder" data-max-width="300" >
                            </div>
                          </div>
                        </td>
                        <td  width='70'></td>
                        ...
                        <td  align='center' width='530'>
                          <div class='contentEditableContainer contentTextEditable'>
                            <div class="contentEditable" style='font-size:13px;color:#99A1A6;line-height:19px;'>
                              <p >Formato de Autorización de Tratamiento Datos Personales Comunidad Ley 1581 de 2012</p>
                            </div>
                          </div>
                        </td>
                        <td  width='70'></td>
                            ...
                            <td width='475' valign='middle'>
                              <div class='contentEditableContainer contentTextEditable'>
                                <div class="contentEditable" style='font-family:Georgia;font-style:italic;color:#0F4666;font-size:15px;line-height:19px;'>
                                  <p style='color:#0F4666;'>
                                    Nombre y Apellido: {{$request->nombres}} {{$request->apellidos}}
                                  </p>
                                  <p style='color:#0F4666;'>
                                    C.C. : {{$request->cedula}}
                                  </p>
                        ...
                        <tr>
                          <td>
                            <div class='contentEditableContainer contentImageEditable'>
                              <div class='contentEditable' style='margin:5%;color:#999999;font-size:13px;line-height:19px;'>
                                <p>Con la firma de este documento manifiesto que autorizo a la CORPORACION CENTRO CARISMATICO MINUTO DE DIOS, para que realice el tratamiento mis datos personales y mis datos sensibles, lo cual consiste en recolectar, almacenar, depurar, usar, analizar, circular, actualizar, y cruzar mi información personal. Todo esto con sujeción a la Ley 1581 de 2012 y sus decretos reglamentarios y con la finalidad de:
                                </p>
                              </div>
                                      ...
                                      <td>
                                        <div class='contentEditableContainer contentTextEditable'>
                                          <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                            <p >•	Suministrar información de contacto a la fuerza comercial y/o red de distribución, telemercadeo, investigación de mercados y cualquier tercero con el cual la CORPORACION CENTRO CARISMATICO MINUTO DE DIOS tenga un vínculo contractual para el desarrollo de actividades de ese tipo (investigación de mercados y telemercadeo, etc.) para la ejecución de las mismas.</p>
                                          </div>
                                        </div>
                                        <div class='contentEditableContainer contentTextEditable'>
                                          <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                            <p >•	Contactar al Titular a través de medios electrónicos – SMS o chat para el envío de noticias relacionadas con campañas de fidelización o mejora de servicio.</p>
                                          </div>
                                        </div>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <div class='contentEditableContainer contentTextEditable'>
                                          <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                            <p>
                                              •	Efectuar encuestas de satisfacción respecto de los bienes y servicios ofrecidos por la CORPORACION CENTRO CARISMATICO MINUTO DE DIOS.
                                            </p>
                                          </div>
                                        </div>
                                        ...
                                        <div class='contentEditableContainer contentTextEditable'>
                                          <div class='contentEditable' style='color:#999999;font-size:13px;line-height:19px;'>
                                            <p >•	Contactar al Titular a través de medios telefónicos para realizar encuestas, estudios y/o confirmación de datos personales necesarios para la ejecución de una relación comercial.</p>
                                          </div>
                                        </div>
                                      </td>
                                    </tr>
                          ...
                          <td width="568" class="specbundle2">
                                ...
                                <td align='left' valign='top'>
                                  <div class="contentEditableContainer contentTextEditable" >
                                   <div class="contentEditable" style='color:#555555;font-size:21px;font-weight:normal;'>
                                    <h2 class='big'>Respecto del tratamiento de datos sensibles, es necesario aclarar que se consideran datos sensibles, aquellos que afectan la intimidad del titular o cuyo uso indebido puede generar su discriminación</h2>
                                  </div>
                                </div>
                              </td>
                            </tr>
                            ...
                            <tr>
                              <td align='left' valign='top'>
                                <div class="contentEditableContainer contentTextEditable" >
                                 <div class="contentEditable" style='color:#999999;font-size:13px;line-height:19px;'>
                                  <p >Respecto del tratamiento de datos personales de menores de edad, en calidad de representante legal de mis hijos menores de edad, autorizo a la CORPORACION CENTRO CARISMATICO MINUTO DE DIOS para que haga el tratamiento, siempre y cuando responda y respete el interés superior de ellos y se asegure el respeto de sus derechos fundamentales.</p>
                                </div>
                              </div>
                            </td>
                          </tr>
                      ...
                      <td valign='top' align='center'>
                        <div class="contentEditableContainer contentTextEditable">
                          <div class="contentEditable" style='color:#A8B0B6; font-weight:bold;font-size:13px;line-height: 30px;'>
                            <p >Corporación Centro Carismático Minuto de Dios</p>
                          </div>
                        </div>
