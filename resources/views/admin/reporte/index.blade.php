...
<div class="row">
  ...
  @endif
<!-- Reporte Titulares -->
@include('admin.reporte.componentes.reporte_titulares')

<!-- Reporte suscripciones -->
@include('admin.reporte.componentes.reporte_suscripciones')
<!-- Reporte Donaciones -->
@include('admin.reporte.componentes.reporte_donaciones')
